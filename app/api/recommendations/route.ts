...
export async function POST() {
  try {
    ...
    console.log(
      "🗺️ [Recommendations API] Found locations:",
      recommendedLocations.length
    );

    // Transform to match the expected format
    const formattedRecommendations: Recommendation[] = recommendedLocations.map(
      (location) => {
    ...
    console.log(
      "🎉 [Recommendations API] Returning recommendations:",
