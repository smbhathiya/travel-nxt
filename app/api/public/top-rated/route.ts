...
export async function GET() {
  try {
    console.log(
      "🗺️ [Public Top Rated API] Fetching top rated locations from database..."
    );
    ...
    console.log(
      "✅ [Public Top Rated API] Found locations:",
    ...
    console.log(
      "🎉 [Public Top Rated API] Returning formatted locations:",
    ...
    console.error(
      "❌ [Public Top Rated API] Error fetching top rated locations:",
      error
    );
