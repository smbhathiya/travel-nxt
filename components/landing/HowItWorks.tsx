  ...
  const steps = [
    {
      ...
      features: ["Select from 10+ categories", "Custom preferences", "Travel style input"],
    },
    {
      ...
      features: ["Advanced algorithms", "Pattern recognition", "Personalized scoring"],
    },
    {
      ...
      features: ["Curated destinations", "Detailed insights", "Easy booking links"],
    },
  ];
    ...
    <div className="container max-w-6xl mx-auto px-4 py-20 sm:py-24">
      ...
      >
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          Your journey to discovering Sri Lanka's best destinations in just three simple steps
        </motion.p>
      </motion.div>
